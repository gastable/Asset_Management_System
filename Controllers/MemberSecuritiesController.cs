...
namespace AMWP.Controllers
{
    ...
    public class MemberSecuritiesController : Controller
    {
        ...
        public ActionResult DisplaySecOrders(int id = 1)
        {
        ...
        public ActionResult _GetMemberSecList(int id = 1) {
        ...
        public ActionResult GetValueLineChart(int id = 1)
        {
        ...
        public JsonResult GetSecPieChart(int id = 1)
        {
            string sql = "queryMemberSecurities";
            List<SqlParameter> list = new List<SqlParameter> {
                 new SqlParameter("id",id)
        ...
        public JsonResult GetSecTypeDoughnutChart(int id = 1)
        {
        ...
        public ActionResult _GetSecTypeList(int id = 1)
        {
            string sql = "queryMemberSecType";
            List<SqlParameter> list = new List<SqlParameter> {
                new SqlParameter("id",id)
