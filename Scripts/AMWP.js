...
function getDailyData(symbol, num) {
    $.ajax({
        type: "get",
        url: "http://localhost:49870/Performance/GetDailyData?symbol=" + symbol + "&num=" + num,
        async: false,
        success: function (data) {
            let i;
...
function getWeeklyData(symbol, num) {
    $.ajax({
        type: "get",
        url: "http://localhost:49870/Performance/GetWeeklyData?symbol=" + symbol + "&num=" + num,
        async: false,
        success: function (data) {
            let i;
            for (i = 0; i < data['Date'].length; i++) {
...
function getMonthlyData(symbol, num) {
    $.ajax({
        type: "get",
        url: "http://localhost:49870/Performance/GetMonthlyData?symbol=" + symbol + "&num=" + num,
        async: false,
        success: function (data) {
            let i;
            for (i = 0; i < data['Date'].length; i++) {
